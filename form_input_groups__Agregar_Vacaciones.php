				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_input_groups.php" class="breadcrumb-item">Forms</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Ingresar vacaciones</h5>
					...
					<div class="card-body">
						<p class="mb-4">En este formulario se agregan los datos de las vacacioness.</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Número del empleado</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Fecha de salida</label>
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Ingrese fecha de salida">
											</span>
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Ingrese fecha de regreso">
											</span>
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Total de días vacacionales</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
											</span>
											<input type="text" class="form-control" placeholder="Ingrese total de días vacacionales">
										</div>
									</div>
								</div>
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
		                    	...
		                    	<button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 rounded-round">Ingresar vacaciones</button>
	                    	</div>
						</div>
					</div>
								<!--
