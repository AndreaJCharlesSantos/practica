			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Eliminar vacaciones</h5>
					...
					<div class="card-body">
						<p class="mb-4">En este formulario se eliminan los datos de las vacaciones.</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Ingrese Estructura">
											</span>
										</div>
									</div>
								</div>
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
		                    	...
		                    	<button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 rounded-round">Eliminar vacaciones</button>
	                    	</div>
						</div>
					</div>
								<!--
