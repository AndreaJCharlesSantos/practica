			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Eliminar departamento</h5>
					...
					<div class="card-body">
						<p class="mb-4">En este formulario se eliminan los datos de los departamentos.</p>
						...
						<div class="card card-body border-top-primary">
							<div class="text-center">
		                    	...
		                    	<button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 rounded-round" >Eliminar empleado</button>
	                    	</div>
						</div>
					</div>
								<!--
