			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Ingresar empresa</h5>
					...
					<div class="card-body">
						<p class="mb-4">En este formulario se ingresan los datos de las empresas.</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Número de empresa</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Estructura jurídica de la empresa</label>
									<div class="col-lg-10">
										<div class="input-group">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">País</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
											</span>
						...
						<div class="card card-body border-top-primary">
							<div class="text-center">
		                    	...
		                    	<button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 rounded-round">Modificar empresa</button>
	                    	</div>
						</div>
					</div>
								<!--
