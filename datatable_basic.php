			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Empleados</span> - Basic</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_basic.php" class="breadcrumb-item">Datatables</a>
					...
					<div class="card-body">
						...
						<div class="btn-group">
					     <button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate dropdown-toggle" data-toggle="dropdown">Ajustes</button>
					   	 	<div class="dropdown-menu dropdown-menu-right">
							<a href="form_input_groups_Modificar.php" class="dropdown-item"><i class="icon-menu7"></i>Modificar</a>
							<a href="form_input_groups_Eliminar.php" class="dropdown-item"><i class="icon-screen-full"></i>Eliminar</a>
							</div>
						</div>
					</div>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							<tr>
								...
								<td>Martínez</td>
								<td>Peréz</td>
											<td class="text-center">MriJs@hotmail.com</td>
								<td>20</td>
								<td>Col.Laura Aguirre</td>
								</td>
								<td>87000</td>
							</tr>
							<tr></tr>
							<tr>
								...
								<td>Puga</td>
								<td>Vega</td>
											<td class="text-center">Aldo@hotmail.com</td>
								<td>18</td>
								<td>Moderna</td>
								</td>
								<td>87000</td>
							...
							<tr>
								...
								<td>Charles</td>
								<td>Santos</td>
											<td class="text-center">joseline@hotmail.com</td>
								<td>18</td>
							...
							<tr>
								...
								<td>Carrera</td>
								<td>Pineda</td>
											<td class="text-center">Aladid@hotmail.com</td>
								<td>19</td>
								<td>Col.Libertad</td>
								</td>
								<td>87019</td>
							...
							<tr>
								...
								<td>Báez</td>
								<td>Guerrero</td>
											<td class="text-center">anel1@hotmail.com</td>
								<td>19</td>
								<td>Col.Libertad</td>
								</td>
								<td>87019</td>
							...
							<tr>
								...
								<td>Huerta</td>
								<td>Vázquez</td>
											<td class="text-center">daniela2@hotmail.com</td>
								<td>19</td>
								<td>Leona Vicario</td>
								</td>
								<td>87137</td>
							...
							<tr>
								...
								<td>Santos</td>
								<td>García</td>
											<td class="text-center">claudiasnts@hotmail.com</td>
								<td>30</td>
								<td>José López Portillo</td>
								</td>
								<td>87010</td>
							...
							<tr>
								...
								<td>Charles</td>
								<td>Santos</td>
											<td class="text-center">alejandra03@hotmail.com</td>
								<td>24</td>
								<td>José López Portillo</td>
								</td>
								<td>87010</td>
							...
							<tr>
								...
								<td>Santos</td>
								<td>Charles</td>
											<td class="text-center">jos0109@hotmail.com</td>
								<td>20</td>
								<td>José López Portillo</td>
								</td>
								<td>87010</td>
							...
							<tr>
								...
								<td>Vázquez</td>
								<td>Torres</td>
											<td class="text-center">torres91@hotmail.com</td>
								<td>26</td>
								<td>Col. Libertad</td>
								</td>
								<td>87019</td>
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th>Total de días vacacionales</th>
											</tr>
										</thead>
										<tbody>
											<tr>
