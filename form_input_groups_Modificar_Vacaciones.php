		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">En este formulario se actualizan los datos de las vacaciones.</p>
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
		                    	...
		                    	<button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 rounded-round">Modificar vacaciones</button>
	                    	</div>
						</div>
					</div>
								<!--
