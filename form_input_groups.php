			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Ingresar empleados</h5>
					...
					<div class="card-body">
						<p class="mb-4">En este formulario se agregan los datos de los empleados.</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Número de empleado</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Apellido paterno</label>
									<div class="col-lg-10">
										<div class="input-group">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Apellido materno</label>
									<div class="col-lg-10">
										<div class="input-group">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Ingrese edad">
										</div>
									</div>					
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Dirección
									</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Ingrese su código postal">
										</div>
						...
						<div class="card card-body border-top-primary">
							<div class="text-center">
		                    	...
		                    	<button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 rounded-round">Ingresar empleados</button>
	                    	</div>
						</div>
					</div>
								<!--
