			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Formulario para transporte</h5>
					...
					<div class="card-body">
						<p class="mb-4">En este formulario se solicitan los boletos para el transporte escolar de la universidad Politécnica de Ciudad Victoria.</p>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Matrícula (7 dígitos)">
										</div>
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre del estudiante</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
											</span>
											<input type="text" class="form-control" placeholder="Ingrese el nombre del estudiante">
										</div>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Carrera que está cursando</label>
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Ingrese carrera ITI/PYMES/MANU/ISA/MECA/LAYGE">
											</span>
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Ingrese el día de pago">
										</div>
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Ingrese la ruta que el estudiante toma Libertad/Tamatán">
										</div>
									</div>
								</div>
							<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Ingrese el horario que toma el estudiante Entrada/Salida">
										</div>
									</div>
								</div>
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
								<h6 class="m-0 font-weight-semibold">Guardar cambios</h6>


		                    	<button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 rounded-round">Ingresar departamento</button>
	                    	</div>
						</div>
					</div>
								<!--
