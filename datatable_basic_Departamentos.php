			...
			<div class="sidebar sidebar-dark sidebar-main sidebar-expand-md">
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-user">
						<div class="card-body">
							<div class="media">
								...
								<div class="media-body">
									<div class="media-title font-weight-semibold">Andrea Charles</div>
					...
					<div class="card card-sidebar-mobile">
						...
						<!-- Forms -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Datos</div> <i class="icon-menu" title="Forms"></i></li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pencil3"></i> <span>Empleados</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
							<li class="nav-item">
							<a href="datatable_basic.php" class="nav-link">
								<i class="icon-home4"></i>
								<span>
									Tabla
								</span>
								...
								<li class="nav-item"><a href="form_input_groups.php" class="nav-link">Ingreso de empleados</a></li>
							</ul>
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item"><a href="form_input_groups_Modificar.php" class="nav-link">Modificar empleados</a></li>
							</ul>

								<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item"><a href="form_input_groups_Eliminar.php" class="nav-link">Eliminar empleados</a></li>
				...
				<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Departamentos</div> <i class="icon-menu" title="Forms"></i></li>
					<li class="nav-item nav-item-submenu">
						...
						<ul class="nav nav-group-sub" data-submenu-title="Form components">
							<li class="nav-item">
								<a href="datatable_basic_Departamentos.php" class="nav-link">
								<i class="icon-home4"></i>
							...
							<li class="nav-item"><a href="form_input_groups_Agregar_Departamentos.php" class="nav-link">Ingresar departamentos</a></li>
							<li class="nav-item"><a href="form_input_groups_Departamentos.php" class="nav-link">Modificar departamentos</a></li>
							<li class="nav-item"><a href="form_input_groups_Eliminar_Departamentos.php" class="nav-link">Eliminar departamentos</a></li>					
						</ul>
					</li>
				<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Empresas</div> <i class="icon-menu" title="Forms"></i></li>
					<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pencil3"></i> <span>Empresas</span></a>
						<ul class="nav nav-group-sub" data-submenu-title="Form components">
							<li class="nav-item">
								<a href="datatable_basic_Empresas.php" class="nav-link">
								<i class="icon-home4"></i>
							...
							<li class="nav-item"><a href="form_input_groups_Empresas_Ingreso.php" class="nav-link">Ingresar empresas</a></li>
							<li class="nav-item"><a href="form_input_groups_Empresas_Modificar.php" class="nav-link">Modificar empresas</a></li>
							<li class="nav-item"><a href="form_input_groups_Eliminar_Empresas.php" class="nav-link">Eliminar empresas</a></li>					
						</ul>
					</li>
				<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Vacaciones</div> <i class="icon-menu" title="Forms"></i></li>
					<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pencil3"></i> <span>Vacaciones</span></a>
						<ul class="nav nav-group-sub" data-submenu-title="Form components">
							<li class="nav-item">
								<a href="datatable_basic_Vacaciones.php" class="nav-link">
								<i class="icon-home4"></i>
				...
				<div class="page-header page-header-light">
					<div class="page-header-content header-elements-md-inline">
						<div class="page-title d-flex">
							<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Departamentos</span> - Basic</h4>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="btn-group">
					     ...
					     <div class="dropdown-menu dropdown-menu-right">
									<a href="form_input_groups_Departamentos.html" class="dropdown-item"><i class="icon-menu7"></i>Modificar</a>
									<a href="form_input_groups_Eliminar_Departamentos.html" class="dropdown-item"><i class="icon-screen-full"></i>Eliminar</a>
								</div>
						</div>
					</div>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							<tr>
								<td>
									<div class="list-icons">
										<a href="#" class="list-icons-item" data-toggle="modal" data-target="#edit_modal"> <i class="icon-pencil7"></i></a>
								...
								<td>
									...
									<li>Convertir su marca en influencer</li>
								</td>
								<td>
									<li>Que los clientes hablen bien de nosotros.</li>
									<li>Hacemos nuestros los proyectos del cliente, tanto online como offline.</li>
								</td>
								<td>
									<li>Escuchamos activamente las necesidades de la empresa.</li>
									<li>Tenemos flexibilidad horaria.</li>
									<li>Redactamos con calidad y adecuadamente.</li>
								</td>
							...
							<tr>
								...
								<td class="text-center"><a href="#">002</a></td>
								<td>Financiero</td>
								<td>
									<li>Incrementar la recaudación de los ingresos propios.</li>
									<li>Mejorar la calidad en la atención.</li>
								</td>
								<td>
									<li>Recaudamos, gestionamos y administramos los recursos financieros.</li>
								</td>
								<td>
									<li>Contar con una administración eficiente y eficaz que satisfaga con calidad y apego a la normatividad los servicios proporcionados.</li>
								</td>
											<td class="text-center"></td>
							</tr>
							<tr>
								...
								<td class="text-center"><a href="#">003</a></td>
								<td>Administrativo</td>
								<td>
									<li>Contar con un modelo institucional moderno y flexible con capacidad de atender en forma ágil y oportuna los requerimientos de la ciudad.</li>
								</td>
								<td>
									<li>Tiene como misión diseñar, implantar, coordinar, supervisar y evaluar las actividades de la empresa. </li>
								</td>
								<td>
									<li>Contar con una administración eficiente y eficaz que satisfaga con calidad y apego a la normatividad los servicios proporcionados.</li>
								</td>
							...
							<tr>
								...
								<td class="text-center"><a href="#">004</a></td>
								<td>Recursos humanos.</td>
								<td>
									<li>Otorgar de manera oportuna y eficiente los beneficios al personal.</li>
									<li>Aumentar la productividad del capital humano dentro de la institución.</li>
								</td>
								<td>Fortalecer la gestión y desarrollo del personal, velando por mantener un clima laboral que fomente el buen desempleño, el compromiso, la responsabilidad, la excelencia y la mejora continua.</td>
								<td>Ser una dirección que promueva el desarrollo integral de los funcionarios, por medio de su realización personal, profesional y laboral para brindar un servicio de excelencia en beneficio de la comunidad.</td>
								<td class="text-center"></td>
								<tr></tr>
								<td><div class="list-icons">
					                		<a href="#" class="list-icons-item" data-toggle="modal" data-target="#edit_modal">
								...
								<td class="text-center"><a href="#">005</a></td>
								<td>Mantenimiento</td>
								<td>
									<li>Asegurar una larga vida útil de la instalación en su conjunto, al menos acorde con el plazo de amortización de la planta.</li>
								</td>
								<td>
									<li>Ayudar a nuestros clientes a conseguir que sus empresas sean más rentables, reduciendo costes y generando compromiso y responsabilidad en sus empleados.</li>
									<li>Eliminar los costes innecesarios generados por un mantenimiento inadecuado, reducir el número de averías, aumentar la disponibilidad de la maquinaria y mejorar la estabilidad del proceso productivo.</li>
									<li>Dar mayor sentido al trabajo, buscando generar compromiso y responsabilidad en el empleado.</li>
								</td>
								<td>
									<li>Ser un referente en el sector industrial por la capacidad de optimizar y racionalizar sistemas, mejorando así la rentabilidad de las empresas. Ser reconocidos por potenciar la innovación y mejorar continua en las empresas.</li>
								</td>
								<td class="text-center"></td>
							</tr>
							<tr></tr>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										Está apunto de eliminar estos datos, ¿está seguro?
									</div>
