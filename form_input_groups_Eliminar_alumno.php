		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">En este formulario se eliminan los datos de los alumnos.</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Matrícula del alumno</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
											</span>
											<input type="text" class="form-control" placeholder="Ingrese la matrícula del alumno">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Ingrese el nombre del alumno">
											</span>
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Ingrese carrera del alumno</label>
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Ingrese carrera del alumno">
											</span>
										</div>
									</div>
								</div>
						...
						<div class="card card-body border-top-primary">
							<div class="text-center">
		                    	...
		                    	<button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 rounded-round" >Eliminar alumno</button>
	                    	</div>
						</div>
					</div>
								<!--
